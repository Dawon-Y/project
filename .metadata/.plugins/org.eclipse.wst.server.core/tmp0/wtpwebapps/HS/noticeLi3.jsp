...
<link rel="stylesheet" href="css/noticeLi3.css">
<title>공지사항</title>
</head>
<body>
...
<div class="contents">
	...
	<hr class= "black">
		<div class="subject">
		<h3>2025학년도 1학기 일반 전부(과) 선발 안내 (~11월 8일까지)</h3>
		<p>작성일 2024.10.28 | 작성자 학사지원팀</p>
	<hr>
		</div>
	</div>
		<div class="mainContents">
			<img class="track" src="img/transfer0.jpg">
			<img class="track" src="img/transfer1.jpg">
			<img class="track" src="img/transfer2.jpg">
		</div>
			<div class="attach">
